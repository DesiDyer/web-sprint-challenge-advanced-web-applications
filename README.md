...
- A token is used for token-based authentication. This allows users to temporariliy get authenticated access to something on the server by storing a token client side.

2. What steps can you take in your web apps to keep your data secure?

- Keep everything up to date and have a strong password with letters, numbers and special characters. Login pages should be encrypted.

3. Describe how web servers work.

- A web server processes incoming network requests over HTTP and several other related protocols. The browser makes a request via HTTP. The server accepts (or denies) the request and sends the requested infromation back to the browser.
